...
import { ChevronDown, Github, Video, Mail } from 'lucide-react'
...
export const translations = {
  en: {
    ...
    step1Desc:
      'Select your large meme or sticker sheet (usually a large JPG or PNG).',
    step2Title: '2. Adjust Grid',
    step2Desc:
      'Set columns and rows. Standard WeChat/Telegram packs are often 6x4.',
    ...
    seo: {
      ...
      description:
        'Free online sticker grid slicer tool. Quickly crop large sticker sheets into individual images. Supports custom grids, one-click ZIP download. All processing happens locally in your browser for privacy.',
      keywords:
        'sticker slicer,sticker crop,grid slicer,sticker tool,image crop,online slicer,sticker split,meme slicer',
      ogTitle: 'Sticker Grid Slicer - Crop Sticker Sheets Instantly',
      ogDescription:
        'Free online sticker grid slicer tool. Quickly crop large sticker sheets into individual images. Supports custom grids, one-click ZIP download.',
      twitterTitle: 'Sticker Grid Slicer - Crop Sticker Sheets Instantly',
      twitterDescription:
        'Free online sticker grid slicer tool. Quickly crop large sticker sheets into individual images.',
  ...
  zh: {
    ...
    step2Title: '2. 调整网格',
    step2Desc: '设置列数和行数。微信/Telegram 表情包通常是 6x4。',
    step3Title: '3. 下载',
    ...
    seo: {
      ...
      description:
        '免费在线表情包切图工具,支持将大图表情包快速裁剪成独立的表情图片。支持自定义网格,一键下载ZIP文件。所有处理均在浏览器本地完成,保护您的隐私。',
      keywords:
        '表情包切图,表情包裁剪,sticker slicer,表情包工具,图片切割,在线切图,表情包分割',
      ogTitle: '表情包切图工具 - 快速裁剪表情包大图',
      ogDescription:
        '免费在线表情包切图工具,支持将大图表情包快速裁剪成独立的表情图片。支持自定义网格,一键下载ZIP文件。',
      twitterTitle: '表情包切图工具 - 快速裁剪表情包大图',
      twitterDescription:
        '免费在线表情包切图工具,支持将大图表情包快速裁剪成独立的表情图片。',
      schemaName: 'Sticker Grid Slicer',
      schemaDescription:
        '免费在线表情包切图工具,支持将大图表情包快速裁剪成独立的表情图片'
    }
